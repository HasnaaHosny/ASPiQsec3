              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    ...
                    // تحقق من الشروط: 8 أحرف على الأقل، حرف كبير، حرف صغير، رقم، ورمز خاص
                    final passwordRegex = RegExp(
                        r'^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[!@#\$%\^&\*])[A-Za-z\d!@#\$%\^&\*]{8,}$');
                    if (!passwordRegex.hasMatch(value)) {
                      return 'يجب أن تكون كلمة المرور 8 أحرف على الأقل وتشمل حرفًا كبيرًا (A-Z)، حرفًا صغيرًا (a-z)، رقمًا (0-9)، ورمزًا خاصًا (!@#\$%^&*)';
                    }
                    return null;
                  },
                ),
