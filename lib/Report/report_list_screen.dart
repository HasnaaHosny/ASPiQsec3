                    ...
                    children: [
                      ...
                      ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              _primaryAppColor, // استخدام اللون المعرف
                        ...
                        onPressed: () {
                          ...
                          if (mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content: Text(
                                "يرجى تسجيل الخروج ثم الدخول مجددًا.",
                                textDirection: TextDirection.rtl,
                              )),
                            );
                          }
                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final reportTitle =
                            _formatReportTitle(report.groupName);
                                    ...
                                    isLoading
                                        ? SizedBox(
                                            ...
                                            child: CircularProgressIndicator(
                                              strokeWidth: 2.0,
                                              color:
                                                  _primaryAppColor, // *** تعديل اللون هنا ***
                                            ))
                                        : ElevatedButton(
                                            style: ElevatedButton.styleFrom(
                                              backgroundColor:
                                                  _primaryAppColor, // *** تعديل لون خلفية الزر ***
                                              foregroundColor: Colors
                                                  .white, // *** تعديل لون نص الزر ***
                                            ),
                                            onPressed: () =>
