...
class PdfGeneratorService {
  ...
  Future<File> generateReportPdf(
    ...
    final String dynamicPdfTitle = _formatReportTitle(reportGroup.groupName);
              ...
              pw.Container(
                ...
                child: pw.Column(
                  children: [
                    ...
                    pw.Text(
                      'الأخصائي: ${reportGroup.doctorName}',
                      style: pw.TextStyle(
                        font: arabicFont,
                        fontSize: 16,
                        color: primaryAppColor,
  ...
  pw.Widget _buildPdfTrainedEmotions(
    ...
    for (var item in goodItems) {
      emotionWidgets.add(
        _buildPdfEmotionItem('${item.title}: ${item.message}', true, font,
            goodIconColor, textColor),
      );
    }
    for (var item in notGoodItems) {
      emotionWidgets.add(
        _buildPdfEmotionItem('${item.title}: ${item.message}', false, font,
            notGoodIconColor, textColor),
      );
    }
      ...
      child: pw.Row(
        children: [
          ...
          pw.Expanded(
            child: pw.Text(text,
                style:
                    pw.TextStyle(font: font, fontSize: 12, color: textColor)),
          ),
        ],
      ),
    );
